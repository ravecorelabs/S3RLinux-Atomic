  ...
  return (
    ...
    >
      <motion.div style={{ marginBottom: '1rem', textAlign: 'center' }}>
        <span style={{ fontSize: '3rem' }}>{char.icon}</span>
      </motion.div>
  ...
  return (
    <div style={{
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        style={{ textAlign: 'center', marginTop: '2.5rem', padding: '0 1rem' }}
      >
        <p style={{ color: '#4a4a5a', fontSize: '0.75rem', letterSpacing: '0.1em' }}>
          © RaveCore-Labs • 2026
        </p>
      </motion.div>
    </div>
